...
float base = 0;
int analog_RightY=127, analog_LeftY=127; // inisialisasi analog joystick
...
float vxMode = 33, vyMode = 33.6, betaMode = 2; //Setpoint vx, vy, dan kecepatan putar
float vxtable[] = {27, 33}; //Dalam cm/s
float vytable[] = {27, 33.6}; //Dalam cm/s
    ...
    if (!boost_forward){    
        ...
        while ((us_ticker_read()/1000)-spdChangeFlag <= 800){
            if ((us_ticker_read()/1000)-computeSpeedFlag >= 35){
                ...
                omega[1] = (80.0/rWheel)/6.28*330*0.035; //1050
                omega[2] = (80.0/rWheel)/6.28*330*0.035; //1050
