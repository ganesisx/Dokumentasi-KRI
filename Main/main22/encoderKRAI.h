...
public:
    ...
    encoderKRAI(const encoderKRAI &enc);
    /******************************************* 
     * Copy Constructor
     *******************************************/
     ...
     *******************************************/
     ...
     long getPulsesTotal(void);
    /*******************************************
     * Membaca pulse total yang didapat oleh encoder
     * @return Nilai pulse total yang telah dilalui.
     *******************************************/   
