...
uint8_t AX12A::turn(uint16_t Speed, bool SIDE, uint8_t s_servoID){
        ...
        if (SIDE == LEFT)
            {
                ...
                instructionBuffer[2] = s_servoID;    // ID
                instructionBuffer[3] = 0x05;         // Length
                instructionBuffer[4] = WRITE_DATA;
                instructionBuffer[5] = ADDRESS_MOVING_SPEED;
                instructionBuffer[6] = Speed_L;
                instructionBuffer[7] = Speed_H;
                instructionBuffer[8] = ~(instructionBuffer[2] + instructionBuffer[3] + instructionBuffer[4] + instructionBuffer[5] + instructionBuffer[6] + instructionBuffer[7]) & 0xFF;
