...
encoderKRAI encMotor[]={
    ...
    encoderKRAI(PA_6, PA_7, 550),        // Motor 1
    encoderKRAI(PC_2, PC_3, 550),     // Motor 2
...
void taskComputeSpeed(){
     angle_Left = getAngle(analog_LeftX, analog_LeftY);
        ...
        omega[1] = ((vytot+vxtot+(beta*(midX+midY)))/rWheel)/6.28*550*0.035; //1050
        omega[2] = ((vytot+vxtot-(beta*(midX+midY)))/rWheel)/6.28*550*0.035; //1050
